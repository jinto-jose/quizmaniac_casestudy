...
public class FirstSampleQuizPage extends BaseClass {
	...
	public boolean checkFirstSampleQuizUrl(){
		return BrowserUtils.getCurrentUrl().contains("a-sample-quizz");
	}
}
