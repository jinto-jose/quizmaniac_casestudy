...
public class ThirdSampleQuizPage extends BaseClass {
	...
	public boolean checkThirdSampleQuizUrl(){
		return BrowserUtils.getCurrentUrl().contains("a-third-sample-quizz");
	}
}
